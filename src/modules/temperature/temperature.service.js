...
class TemperatureService {
  ...
  async createTemperatureRecord(data) {
    try {
      ...
      if (data.value > 40 || data.value < 10) {
        console.log("Temperatura alterada! Enviando para fila de alerta");

        const message =
          data.value < 10
            ? "Temperatura abaixo do valor recomendado"
            : "Temperatura acima do valor recomendado";
